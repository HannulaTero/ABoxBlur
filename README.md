...
- blur is surface, which tells how strongly blur should be applied. 
- strength is how strongly blur is applied in general
- fallback is wether use compatibility rgba8unorm-version (no float-textures). Default is false.
