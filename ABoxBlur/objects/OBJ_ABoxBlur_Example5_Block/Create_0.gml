...
self.xscale = random_range(1.0, 2.0);
self.yscale = self.xscale;
self.zscale = self.xscale;
self.xspin  = random_range(-0.01, +0.01);
self.yspin  = random_range(-0.01, +0.01);
self.zspin  = random_range(-0.01, +0.01);
